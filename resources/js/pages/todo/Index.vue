        ...
        <div class="mycard mx-auto mt-10 max-w-2xl">
            <div class="mycard-body">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <Button variant="destructive" size="sm" @click="removeAll" class="gap-2">
                ...
                <form @submit.prevent="create" class="mb-2 flex gap-2">
                    <div class="flex-1">
                        ...
                        }" v-model="form.name" placeholder="What needs to be done?" />
                    </div>
                ...
                <ul ref="todoListRef" class="mt-6">
                    <li v-for="element in dtodos" :key="element.id"
                        ...
                        <button @click="status(element)" class="focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" :stroke="element.status == '1'
                                    ? '#10b981'
                                    : 'currentColor'
                                " viewBox="0 0 24 24" stroke-width="2" class="size-6 transition-colors">
                        ...
                        <div class="ml-3 flex-1">
                            <span v-if="!element.editMode" @click="element.editMode = true"
                                class="block w-full cursor-pointer" :class="{
                        ...
                        <button class="ml-2 opacity-0 transition-opacity group-hover:opacity-100" @click="
                            confirmDeleteActive = true;
                        deleteTodoRow = element.id;
                        ">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ef4444" class="size-5">
